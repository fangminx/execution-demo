...
public class AdviceAspectConfig {
    ...
    @Pointcut("execution(* *..find*(Long)) && within(com.fangminx..*) ")
    public void matchLongArg(){}

    @Pointcut("execution(public * com.fangminx.service..*Service.*(..) throws java.lang.IllegalAccessException) && within(com.fangminx..*)")
    public void matchException(){}

    @Pointcut("execution(String com.fangminx..*.*(..)) && within(com.fangminx..*)")
